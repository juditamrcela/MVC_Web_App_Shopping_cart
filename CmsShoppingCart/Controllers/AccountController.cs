...
{
    //mozemo uci u stranicu samo ako prodemo autorizaciju
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(Login login)
        {
            if (ModelState.IsValid)
            {
                ...
                ModelState.AddModelError("", "Neuspješna prijava, neispravni podaci.");
            }
            return View(login);
        }
        //GET /account/logout
        ...
        public async Task<IActionResult> Edit(UserEdit user)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                    TempData["Success"] = "Vaši podaci su promjenjeni";
            }
            return View();
        }
