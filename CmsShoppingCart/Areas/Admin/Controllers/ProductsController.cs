...
namespace CmsShoppingCart.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(CmsSchoppingCartContext context, IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            int pageSize = 6; //dodajem koliko prodkuta zelim vidjeti na stranici
            var product = context.Products.OrderByDescending(x => x.Id).Include(x => x.Category).Skip((p - 1) * pageSize).Take(pageSize);
